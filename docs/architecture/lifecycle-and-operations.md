...
The package has no automatic local capture, GitHub filing, or scheduler plane.
Preserve the typed coordinator response. Any later issue report is an explicit,

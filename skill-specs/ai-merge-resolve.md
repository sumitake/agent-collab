...
**Explicit triggers** (user-typed): "resolve this merge conflict," "ai-merge," "merge with {{ verifier_agent }}," "have {{ verifier_agent }} help merge," "AI-resolve this conflict," "use {{ verifier_agent }} to merge this."

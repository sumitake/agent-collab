...
{{ orchestrate_defaults_block }}
description: Coordinate a multi-step WORK task through a bounded task graph with explicit dependencies, authority, acceptance checks, and operator gates. Use when the user says "orchestrate this," "run this as a task graph," or "/{{ package_name }}:orchestrate." Also offer this proactively when three or more independent or dependent work units need a durable integration plan.
---

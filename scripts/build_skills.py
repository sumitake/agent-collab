...
def inject_runtime_invocation(spec_name: str, rendered: str) -> str:
    ...
    block = prefix + (
        ...
        "Use `depends_on` only for actual dependencies. Honor an operator-named "
        "provider with `explicit_target`. For an authorized independent review or "
        ...
        "The coordinator fills the installed wire digest and reads each "
